//=============================================================================
// CinoGear Brand Adaptation Notice
// Package: CinoGear Spider 18DOF / BotBoarduino_CH3R_PS2
// Purpose: Branded source layout prepared from the user-provided archive.
// Compatibility references retained for SSC-32 / BotBoarduino / Phoenix / PS2X.
// Third-party names remain the property of their respective owners and are used
// only to describe hardware/software compatibility and upstream lineage.
// See ../docs/THIRD_PARTY_REFERENCES.md before any commercial release.
//=============================================================================
